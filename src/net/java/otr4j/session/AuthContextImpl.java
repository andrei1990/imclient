...
class AuthContextImpl implements AuthContext {
    ...
    public void setRemoteDHPublicKey(DHPublicKey dhPublicKey) {
        ...
        Log.i("handshake","Received D-H Public Key is a legal value.");
    ...
    private void handleRevealSignatureMessage(RevealSignatureMessage m) throws OtrException {
        Session session = getSession();
        SessionID sessionID = session.getSessionID();
        Log.i("handshake",sessionID.getAccountID());
        logger.finest(sessionID.getAccountID() + " received a reveal signature message from "
                      + sessionID.getUserID() + " throught " + sessionID.getProtocolName() + ".");

        if (!session.getSessionPolicy().getAllowV2()) {
            logger.finest("Policy does not allow OTRv2, ignoring message.");
            Log.i("handshake","Policy does not allow OTRv2, ignoring message.");
            return;
        }
        ...
        case AWAITING_REVEALSIG:
            ...
            Log.i("handshake","Signature verification succeeded.");
            ...
            break;
        default:
        	 Log.i("handshake","Igonoring message");
    ...
    private void handleDHKeyMessage(DHKeyMessage m) throws OtrException {
        ...
        case AWAITING_DHKEY:
            ...
            Log.i("handshake","Sent Reveal Signature.");
            break;
        case AWAITING_SIG:
            ...
            if (m.dhPublicKey.getY().equals(this.getRemoteDHPublicKey().getY())) {
                ...
                Log.i("handshake","ReSent Reveal Signature.");
