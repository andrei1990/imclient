...
public class OtrEngineImpl implements OtrEngine {
    ...
    public OtrEngineImpl(OtrEngineHost host,Context context) {
        if (host == null)
	...
	public void setSessions(Map<SessionID, Session> sessions) {
	...
	public Session getSession(SessionID sessionID) {
        ...
        if (!sessions.containsKey(sessionID)) {
            Session session = new SessionImpl(sessionID, getHost(),context);
