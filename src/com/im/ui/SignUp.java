...
public class SignUp extends Activity {
	...
	private static final int ENTER_A_CORECT_EMAIL_ADDRESS=10;
	private int TRY_NUMBER_COUNTER=0;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		signUpButton.setOnClickListener(new OnClickListener() {
			public void onClick(View arg0) {
				if (usernameText.length() > 0 && passwordText.length() > 0
					...
					if (emailValidator.validate(eMailText.getText().toString())) {
						...
						showDialog(ENTER_A_CORECT_EMAIL_ADDRESS);
					}
				} else {
		...
		cancelButton.setOnClickListener(new OnClickListener() {
			public void onClick(View arg0) {
				finish();
				Intent welcomeIntent = new Intent(SignUp.this,
						WelcomeScreen.class);
	...
	protected Dialog onCreateDialog(int id) {
		...
		case ENTER_A_CORECT_EMAIL_ADDRESS:
			return new AlertDialog.Builder(SignUp.this)
					.setMessage(R.string.wrong_email_address)
					.setPositiveButton(R.string.OK,
							new DialogInterface.OnClickListener() {
								public void onClick(DialogInterface dialog,
										int whichButton) {
