...
public class FriendRequestResponseActivity extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String names = extras.getString(FriendModel.FRIEND_LIST);
	...
	public boolean onMenuItemSelected(int featureId, MenuItem item) {
		...
		case APPROVE_SELECTED_FRIENDS_ID: {
			...
			Toast.makeText(FriendRequestResponseActivity.this,
					R.string.request_sent, Toast.LENGTH_SHORT).show();
	...
	protected void onResume() {
		super.onResume();
		bindService(new Intent(FriendRequestResponseActivity.this,
